...
//undefined
/*
Undefined usually means a variable has been declared, but uts not been assigned a value
*/
...
/*
Null and undefined both represent variables with no value inside. Think of it this way--null values are for gag gifts that are boxes intentionally given with nothing inside (becuase that's the gag). Undefined values are gifts given when the person giving the gift has forgotten to put the gift inside (oops!). 
*/
...
Denoted by {}
Have keys and values (color (key): 'blue' (value), separated with a colo, each key-value pair is separated with a comma.
*/
